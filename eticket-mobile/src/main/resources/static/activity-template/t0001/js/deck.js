...
var Deck = (function () {
    ...
    card: function card(_card3) {
      ...
      _card3.shuffle = function (cb) {
        ...
        _card3.animateTo({
          ...
          onComplete: function onComplete() {
            cb(i);
            if(____shuffle_callback)____shuffle_callback(i);
          }
        });
      };
    }
  ...
  var poker = {
    deck: function deck(_deck4) {
      ...
      function poker(next) {
        ...
        cards.slice(30).reverse().forEach(function (card, i) {
    ...
    card: function card(_card4) {
      ...
      _card4.poker = function (i, len, cb) {
        ...
        _card4.animateTo({
          ...
          x: Math.round(0 * __fontSize / 16),
          y: Math.round(0 * __fontSize / 16),
          rot: 0,
  ...
  function Deck(jokers) {
    // init cards array
    var cards = new Array(jokers ? jokers : 52);
